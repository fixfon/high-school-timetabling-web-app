...
const Privacy: NextPage = (props) => {
  return (
    <>
      <Head>
        <title>Privacy Policy | TimetablePro</title>
        <meta
          name="description"
      ...
      <Layout>
        <div className="container py-12">
          ...
          <div className="mx-auto mt-12 flex w-4/5 flex-col items-center justify-center space-y-8">
            <p className="self-start text-sm italic">
            ...
            <h3 className="self-start font-bold">Interpretation</h3>
            <p>
            ...
            <h3 className="self-start font-bold">Definitions</h3>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                  &quot;Our&quot; in this Agreement) refers to TimetablePRO.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to TimetablePRO, accessible
                  from{" "}
                  <Link
                    href="http://timetablepro.vercel.app"
                    rel="external nofollow noopener"
                    target="_blank"
                    className="underline transition-colors hover:text-primary"
                  >
                    http://timetablepro.vercel.app
                  </Link>
                </p>
              </li>
              <li>
            ...
            <h3 className="self-start font-bold">Types of Data Collected</h3>
            <h4 className="self-start font-bold">a- Personal Data</h4>
            <p>
            ...
            <h4 className="self-start font-bold">b- Usage Data</h4>
            <p className="self-start">
            ...
            <h4 className="self-start font-bold">
            ...
            <h3 className="self-start font-bold">Use of Your Personal Data</h3>
            <p className="self-start">
            ...
            <h3 className="self-start font-bold">Delete Your Personal Data</h3>
            <p className="self-start">
            ...
            <h4 className="self-start font-bold">a- Business Transactions</h4>
            <p>
            ...
            <h4 className="self-start font-bold">b- Law enforcement</h4>
            <p>
            ...
            <ul className="self-start">
              <li>
                ...
                <Link
                  href="http://timetablepro.vercel.app/contact"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="underline transition-colors hover:text-primary"
                >
                  http://timetablepro.vercel.app/contact
                </Link>
              </li>
            </ul>
          </div>
