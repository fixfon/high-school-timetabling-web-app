...
const Login: NextPage = (props) => {
  ...
  return (
    <>
      ...
      <div className="flex h-screen w-full items-center justify-stretch bg-background-light text-lg text-text-dark/70">
        <div className="flex min-h-full w-full flex-col px-4 py-12 lg:w-3/5 lg:px-8">
          ...
          <div className="my-auto flex h-full max-w-[80%] flex-col self-center">
            ...
            <div className="h-3/4">
              <form
                noValidate
                className="mx-auto flex w-3/5 flex-col items-center justify-center text-base"
              ...
              >
                ...
                <button
                  type="submit"
                  className="mt-16 w-4/5 rounded-lg bg-primary py-1 text-lg font-medium text-secondary transition-all hover:bg-button-hover-primary"
                >
                  Login
                </button>
              </form>
